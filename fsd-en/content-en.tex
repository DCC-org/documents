...
Other tasks, like marketing analysis requires aggregated data, but over a way
longer timeframe. This is settled to one year in this project. The perfect
aggregation has to be figured out during the project.
