...
\begin{figure}[tbp]
  \centering
%%  \includesvg[svgpath=../figures/,path=../figures/]{messagebusv1}
  \includegraphics[width=1.0\textwidth]{../figures/messagebusv2_2.pdf}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[]{../figures/grana_metrics.png}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[]{../figures/grafana_threshold.png}
  \caption{Grafana Graph Schwellenwert Beispiel}
\label{figure:grafana_threshold}
\end{figure}
