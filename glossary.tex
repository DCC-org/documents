...
{
  name=iowait,
  description={Unter einem iowait definiert man die Aufgabe des Prozessors, bis hier eine
              bestimmte Ein- und Ausgabe durchgeführt werden kann.}
}
\newglossaryentry{Interrupt}
{
  name=Interrupt,
  description={Unter einem Interrupt versteht man die vorrübergehende Unterbrechung
              eines bestimmten Prozess, damit andere Prozesse, welche kürzer abgearbeitet
              werden können vorrang zu gewähren.}
}
\newglossaryentry{Soft-IRQ}
{
  name=soft-IRQ,
  description={Ein Soft-IRQ wartet auf die \gls{Interrupts} um diese verarbeiten zu können.}
}
