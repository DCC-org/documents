...
\newglossaryentry{iowait}
{
  ...
  description={Ein iowait beschreibt, ob ein Prozessor mit der Verarbeitung von
              Aufgaben warten muss, weil zum Beispiel der Datenspeicher (HDDs, SSDs)
              mit lesen oder schreiben nicht hinterherkommen.}
}
\newglossaryentry{Interrupt}
{
  name=Interrupt,
  description={Ein Interrupt ist die vorrübergehende Unterbrechung eines bestimmten
              Prozesses, damit andere Prozesse, welche wichtier sind Vorrang bekommen.
