...
{
  name={Singlestat Panel},
  decription={Ein Singlestat Panel ist eine Zusammenfassung aus mehreren Werten
              und kann z.B. eingesetzt werden bei aktuellen Login versuchen.}
