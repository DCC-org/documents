...
Graphite fiel auf, das es deutlich komplizierter ist, dies zu Installieren,
wie auch zu konfigurieren. Beispielsweise kann die Installation von Graphite
nur auf bestimmte Unix Maschinen durchgeführt werden. Laut der Dokumentation von
Graphite wird hier empfohlen eine Ubuntu Distribution zu verwenden. Die
Konfigurationen von zum Beispiel Datenbanken wird hier nicht direkt in der 
Weboberfläche durchgeführt, sondern muss in bestimmten Konfigurationsdateien auf
dem Server direkt angepasst werden. Nachdem Grafana und Graphite
gegenübergestellt wurde, wird Graphite nicht für die weitere Implementierung in
dem Projekt aufgenommen. Die Konfigurationen und Anpassung von Datenbanken, wie
auch Graphen können bei Grafana direkt auf der Weboberfläche durchgeführt
werden, wodurch Grafana für die weitere Implementierung verwendet wird.
\mr%
