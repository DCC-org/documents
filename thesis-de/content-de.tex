...
das Netzwerk werden diese im \glslink{Carbon}{Graphite Format} geschickt. Über
...
\begin{outline}
  ...
  \1 Nur zwei \glslink{Templates}{Webtemplates} verfügbar (dark/white)
\end{outline}
\mr%
...
hat Gridster\hyp{}D3 0,00 Gesamtpunkte in der Nutzwertanalyse erhalten. Im Laufe
der Evaluierung hat Netdata 2,35 Gesamtpunkte erhalten, da es sehr
unübersichtlich aufgebaut ist und keine Sicherheit gewährleisten kann. Alle drei
...
Netdata, wurde auch hierfür eine Nutzwertanalyse durchgeführt, die wie folgt
aussieht:
...
gegliedert. Im ersten Teil befinden sich alle
 \glslink{Hypervisor}{Hypervisors} und virtuellen Maschinen, welche Daten via
...
Prozesse gestartet worden sind und wenig Daten von den
 \glslink{Hypervisor}{Hypervisors} kommen (zum Beispiel weil gerade viel VMs
deaktiviert sind oder Wartungsarbeiten an Teilen der Infrastruktur durchgeführt
wird). Wenn ein Kunde live seine Auslastung visualisieren möchte, dauert dies
...
Datenbank, da dies zu wesentlich mehr \gls{SQL}\hyp{}Statements führt.
...
Zwischenspeicher von 0. Somit wird jeder Datensatz von diesem Kunden direkt
...
beliebige Umgebungen mit Linux  \glslink{Hypervisor}{Hypervisors} integiert
