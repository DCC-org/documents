...
\label{subsection:datenerfassungssysteme}
...
\section{Datenerfassungssysteme}
Im Abschnitt~\ref{subsection:datenerfassungssysteme} wurde bereits auf die
...
\label{subsection:Begriffserklärung}
...
Abschnitt~\ref{subsection:Begriffserklärung} erklärt. Das gleiche gilt für
...
die im Abschnitt~\ref{subsection:datenerfassungssysteme} definierten Typen.
...
Metrik~\ref{subsection:Begriffserklärung}, welche die Weboberfläche aus den
...
oder mehrere Timeseries~\ref{subsection:Begriffserklärung}.
...
\label{subsection:CPU_Userstory}
...
Hier kann es ebenfalls wie auch bei der~\ref{subsection:CPU_Userstory}
