...
und der Weboberfläche kann somit mit einer sogenannten API (verweis API kommt noch)
realisiert werden. Somit kann hier keine Änderung durch dritter an den
Datenhaltungssystemen durchgeführt werden.

Die zweite Schnittstelle ist die Ausgabe der durch die Datenhaltungssystem
erhaltenen Daten in einem Graphen(Verweis auf Section Graph) auf der
