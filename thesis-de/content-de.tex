...
Linter und Syntax Test, werden immer genau dann benötigt, wenn Quellcode immer
komplexer wird. Ein Linter Test, prüft von einem Quellcode die Formatierung und
macht diesen anschließend lesbarer, damit auch Leien diesen Quellcode gut
verstehen können. Dieser prüft der Linter mit einer hinterlegten Liste, da jede
Programmiersprache andere Formatierungen besitzt. Ein Syntax Test macht eine
statische Code analyse und prüft, ob der Code syntaktisch in Ordnung ist. Dies
bedeutet das geprüft wird, ob keine Klammer (öffnen oder schließen) vergessen
wurde oder ein simikolon an der richtigen Stelle ist.
\mr%
