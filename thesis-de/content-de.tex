...
Die Firma Zabbix LLC wurde wurde 2005 gegründet. Sie pflegt die Open Source
Produkte zabbix-agent (im folgenden Abschnitt Agent genannt), zabbix-server und
zabbix-frontend (siehe auch Abschnitt~\ref{paragraph:zabbix-frontend} for die
...
Community bietet dafür fertige Scripte an~\cite{zabbix_virt_plugin}.
...
ist der zabbix-agent nicht im Projekt nutzbar~\site{zabbix_architecture}.
\tm%
