...
\begin{outline}
  ...
  schreiben
  \1 Logging, erlaubt es, collectd interne Fehler und Warnungen in
  verschiedenen Formen zu speichern und auszugeben
\end{outline}
...
Cassandra\hyp{}Umfeld wird dies über das von dem Hersteller definierte
Protokoll „gossip“ verwaltet. Es handelt sich dabei um ein
Kommunikationsprotokoll, welches den Austausch von Statusinformationen und
Metainformationen zwischen den einzelnen Nodes ermöglicht. Wenn auf einem
einzelnen Node Dateninformationen erstellt, modifiziert oder entfernt werden,
erhält ein weiterer Node in der Infrastruktur diese Information und baut
gleichzeitig eine Replikation des Objektes. Diese Replikationen werden von dem
Serveradministrator definiert, indem dieser den Datenmengen verschiedene
\gls{Partitionen} zuteilt. Das Cassandra\hyp{}System verteilt jede dieser
\gls{Partitionen} an die im Netzwerk vorhandenen Nodes in einer
\gls{Ringtopologie}. Dies bedeutet, dass Partition eins auf dem ersten Node
repliziert wird, Partition zwei auf dem zweiten Node und immer so weiter, bis
das Verfahren den ersten Node wieder erreicht.
...
\glslink{Statement}{Statements} über eine \gls{API}\hyp{}Datenabfrage oder
...
Daten und das Ausliefern der Daten an andere Systeme/\glslink{API}{APIs}, nicht
...
Da sich bei diesem Modell die Geschwindigkeit der Datenabfragen mit der Menge
...
jeweiligen \glslink{Dashboard}{Dashboards} hat der Administrator oder Benutzer
...
Anforderungen vom Kunden gewünscht sind. \glslink{Dashboard}{Dashboards} werden
...
\glslink{Dashboard}{Dashboards} oder direkten URL\hyp{}Adressen zu Webseiten
...
\glslink{Repository}{Repositorys} besitzt. Dies wurde behoben und der Fix
...
anderen kann mit Logstash \glslink{Quality of Service}{QoS} gemacht werden.
