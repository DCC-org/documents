...
\begin{outline}
  ...
  \1 Bei der Weboberfläche sollte ebenfalls auf die Performance geachtet werden,
  so sollen Graphen und Werte schnell ohne große Zeitdifferenzen aus dem 
  Datenhaltungssystem abgerufen werden können. Ebenso, sollte der Aufbau des
  Dashboards beim neuladen der Seite, oder aber auch ein Wert z.B. der CPU 
  Auslastung ändert sich massiv direkt angezeigt werden können, ohne einen 
  Zeitlichen unterschied merken zu können.
\end{outline}
\mr%
...
bereitet diese auf und speichert sie anschließend in einem Datenhaltungssystem
ab. Zusätzlich ist aufgefallen, das Zabbix-Frontend maximal nur mit einer
Datenbank gleichzeitig kommunizieren und verwenden kann. Anders als bei
