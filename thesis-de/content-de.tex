...
mit dem HBase\hyp{}System über einfache Protokolle wie Telnet oder HTTP
(\gls{API}).
...
LDAP\hyp{}Anbindung durchgeführt werden. So benötigt der Administrator
...
Erhaltung eine HTTPS\hyp{}~\gls{API} Schnittstelle verwendet, welche im
Laufe des Projektes entwickelt und entworfen worden ist. Die
HTTPS\hyp{}~\gls{API} liefert hier ein \gls{JSON}\hyp{}Objekt zurück. Damit
Grafana dieses als Datenquelle verwenden kann, muss hier zuvor noch ein Plugin
installiert werden. Es stehen viele verschiedene Plugins auf der Grafana
...
kann unter Datenquelle die HTTPS\hyp{}~\gls{API} angesprochen werden. Sie wird
