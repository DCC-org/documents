...
Die erste Schnittstelle der Weboberfläche hat nur eine lesende Berechtigung,
auf den Datenhaltungssystemen, da keine Änderung durch die Weboberfläche
durchgeführt werden muss. Die Schnittstelle zwischen den Datenhaltungssystemen
und der Weboberfläche kann somit mit einer sogenannten
API~\ref{subsec:schnittstelle_datenbereitstellung} realisiert werden. Somit
kann hier keine Änderung durch dritter an den Datenhaltungssystemen
durchgeführt werden.

Die zweite Schnittstelle ist die Ausgabe der durch die Datenhaltungssystem
erhaltenen Daten in einem Graphen~\ref{definition_eines_graphen} auf der
Weboberfläche. Die Übertragung der Ausgabe der Daten, bzw. das Aufrufen der
...
Client zu Weboberfläche und zurück, als auch damit die Weboberfläche 
