...
\begin{outline}
  ...
  Datenvisualisierung, durch ein API System gesteigert.
\end{outline}
...
\begin{outline}
  \1  In der Grundanforderung unter Abschnitt~\ref{section:anforderungen} ist
  definiert, dass eine Aktive und inhaltlich gute Community vorrausgesetzt
  wird. Der Auftraggeber und auch die Projektmitglieder selbst, benötigen
...
\begin{outline}
  ...
  \1 Nur zwei Design \glslink{Templates}{Webtemplates} verfügbar (dark/white)
\end{outline}
\mr%
...
virtuellen Instanz vorgesehen. Durch die in Punkt
~\ref{subsec:zusammenspiel_api_frontend} erläuterte Mapping\hyp{}Tabelle wird
sichergestellt, dass der Benutzer nur die zu Ihm zugeordneten Daten sehen kann.
Administratoren oder andere Mitarbeiter eines Unternehmens, wie zum Beispiel
ein Kundenberater, erhalten mehrere Zuordnungen von Organisations\hyp{}IDs.
...
stattdessen wird seinem bestehenden Benutzer eine weitere Organisations\hyp{}ID
hinzugefügt.

Ebenso ist es möglich, weitere Administratoren zu erstellen. Dies kann
