...
Die Weboberfläche muss ausgewählten Benutzern eine Übersicht über die Nutzung einzelner Virtuellen oder Physische Maschinen bereitstellen.
Hierbei ist wichtig, das die Sicherheit der Daten gewährleistet wird. Dies bedeutet, das sowohl die Verbindung zwischen Datenbank
und Weboberfläche gesichert sein muss, als auch die Weboberfläche selber, gegen Zugriff von Unbekannten. Die Weboberfläche greift mittels API
Abfragen auf die Datenbank zu und kann somit die Sicherheit gewährleisten. Die Weboberfläche soll Administratoren bei Neukonfiguration
unterstützen und zeigt hier die Auslastung der einzelnen Systemen. Der Administrator kann so gezielt die Systeme besser auslasten und 
verteilen. Ebenfalls kann das Frontend eine Schnittstelle für komplexe Abfragen und Analysen bereitstellen. Bei Bedarf können diese auch
Virtualisiert ausgegeben werden.
[MR]
