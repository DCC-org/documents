...
\begin{outline}
  ...
  \1 Die verwendete Datenvisualisierungssoftware muss API Anfragen ausführen
  können. Dies dient zum einen der Sicherheit, da auf die Datenhaltung nur
  lesender Zugriff gewährleistet werden kann, so können hier Daten in der
  Datenhaltung nicht verändert oder angepasst werden werden und zum anderen
  kann hier bereits die Performance der Datenvisualisierung verbessert werden.
