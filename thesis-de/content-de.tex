...
\subsubsection{JDBC-ODBC}
Hierbei spricht der JDBC Treiber einen sehr generischen \gls{ODBC} Treiber an.
Dieser kommuniziert mit einer Bibliothek des DBMS.
...
\begin{outline}
  ...
  ergibt sich eine lange Liste an alternativen DBMS, die man nutzen kann.
\end{outline}

Die Nachteile sind:

\begin{outline}
  \1 Durch die große Anzahl an Komponenten, die die Daten durchfliesen, ergeben
  sich viele Fehlerquellen.
  \1 Da alle Schnittstellen sehr generisch sind, kann dort keine Optimierung
  auf ein spezifisches DBMS erfolgen.
\end{outline}

\subsubsection{Nativer API Client}
