...
seit vielen Jahren auch im Bereicht der Softwareentwicklung vertreten. Hinzu
...
Die Firma Puppet benutzt mit großem Erfolg agile Softwareentwicklung seit
Jahren für Ihre Produkte. Sie steht dem Projektteam mit hilfreichen Tips und
Schulungen zur Seite. ``Agile Softwareentwicklung'' gilt als Oberbegriff für
alle Techniken und Vorgehensweisen in dem Bereich. Die
Softwareentwicklungsmodelle Kanban und Scrum nutzen Teile der agilen
Softwareentwicklung. Das Projektteam entschied sich für die Nutzung agiler
Projektmanagement Methoden da diese in der Wirtschaft aktuell am verbreitesten
sind.
\tm%

\subsection{Scrum und Kanban}
Scrum ist zu unflexibel für ein Technikerprojekt. Die Methode schreibt vor, das
man alle Techniken von Scrum nutzen muss und diese nicht abwandeln darf. Unter
anderem wird ein ``Daily Standup'' verlangt. Dies ist eine Besprechung an jedem
Arbeitstag, welches genau 15 minuten lang ist. Die Zeit muss gleichmäßig auf
alle Teilnehmer verteilt werden. Aufgrund der Vollzeitbeschäftigung aller
Mitglieder in Kombination mit dem Abendunterricht erfolgen viele Arbeiten am
Projekt asynchron. Die Durchführung von täglichen Besprechungen ist nicht
praktikabel.
\tm%
...
einer Liste für eine darauffolgende Evalution definieren. Bei der Erstellung
...
Evalutionskriterien aus Punkt~\ref{subsubsec:vorbereitung_der_evalution}
