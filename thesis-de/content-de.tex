...
die Softwarelösung \texttt{Gridster-D3} keine direkte Visualisierungssoftware
ist. Die entsprechende Evaluierung, von diesem Produkt, kann unter
...
Softwärelösungen sind damit ausgeschieden, da eine mindest Gesamtpunktzahl von
...
durchgeführt worden ist, hat die Zabbix-Frontend Softwarelösung eine
...
Datenbanken direkt angesprochen. Bei der Evaluierung der Graphite
...
die Weboberfläche wäre nicht mehr erreichbar. Zusätzlich ist hier gerade in
der Wartung der Dienste ein Mehraufwand, da der Administrator alle Dienste in
Form von Abhängigkeit zueinander und Konfiguration kennen muss. Da Graphite aus
