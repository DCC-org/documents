...
eigentlichen Puppet Modul, welche uns die Ressourcentypen grafana-dashboard,
sowie grafana-datasource bereitstellt. Hierzu wurde ein Bugreport beim
Entwickler des Puppet Moduls erstellt~\cite{grafana-issue}.
\mr%
