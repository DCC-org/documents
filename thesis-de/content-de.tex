...
gehört zu einer der meist eingesetzten Softwarelösungen im Bereich Monitoring
...
verfügt über eine inhaltlich gute und umfangreiche Community, mit einem eigenem
...
voraussetzt. Graphite ist ein System, welches aus zwei Diensten besteht. Der
graphite-web Apache Dienst ist für die Anzeige der Weboberfläche zuständig,
welcher benötigt wird um die Weboberfläche anzeigen zu können. Der carbon-cache
Dienst wird verwendet um die Daten, welche vom Datenerfassungsystem ermittelt
worden sind aufzuarbeiten um sie als Graph von Graphite anzeigen lassen zu
können. Grunsätzlich installiert sich mit der Installation von Graphite noch
eine Whisper Datenbank, welche jedoch durch eine beliebige zum Beispiel InfluxDB
