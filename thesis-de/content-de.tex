...
\label{subsubsec:elasticsearch_beschreibung}
Some Text here!
\nl%
\subsubsection{Evaluierungsbericht}
\label{subsubsec:elasticsearch_evaluierung}
Some Text Here!
\nl%
...
\subsubsection{Beschreibung}
\label{subsubsec:cassandra_beschreibung}
Some Text here!
\nl%
\subsubsection{Evaluierungsbericht}
\label{subsubsec:cassandra_evaluierung}
Some Text Here!
\nl%
...
\subsubsection{Beschreibung}
\label{subsubsec:postgres_beschreibung}
Some Text here!
\nl%
\subsubsection{Evaluierungsbericht}
\label{subsubsec:postgres_evaluierung}
Some Text Here!
\nl%
...
\subsubsection{Beschreibung}
\label{subsubsec:opentsdb_beschreibung}
Some Text here!
\nl%
\subsubsection{Evaluierungsbericht}
\label{subsubsec:opentsdb_evaluierung}
Some Text Here!
\nl%

\subsubsection{Hadoop / Hive /Impala}
\label{subsubsec:hadoop_hive_impala}
\subsubsection{Beschreibung Hadoop}
...
~\ref{subsubsec:hadoop_beschreibung} und 
~\ref{subsubsec:impala_beschreibung} erläutert werden.
