...
jedoch, wie auch\glslink{HDD}{HDDs}, einen Lebenszyklus, der bei \glslink{SSD}{SSDs}
schneller erreicht werden kann, als bei handelsüblichen \glslink{HDD}{HDDs}. Der Administrator
soll darüber benachrichtigt werden, sobald von einer \gls{SSD} ein kritischer
Schreib- oder Lesezyklus erreicht worden ist, um die \gls{SSD} bereits vor dem
Ausfall proaktiv austauschen zu können.  Ebenfalls soll eine Statistik
ausgegeben werden können, welche \gls{SSD} von welchem Hersteller in der
Wahrscheinlichkeit am häufigsten ausfällt. Im Folgenden finden sich die
Akzeptanzkriterien:
