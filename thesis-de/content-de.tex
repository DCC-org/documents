...
wird innerhalb dieser Tests ausgeführt und geprüft, ob die Funktionalität der
einzelnen Module für den Benutzer gegeben ist. Diese Szenarien prüfen
beispielsweise, ob die Erhaltung der Daten, sowie speichern dieser Daten in der
Datenbank und Visualisierung der Graphen funktioniert. Es wird hier nicht
geprüft, ob die Stabilität des Systems gegeben ist sondern lediglich, ob die
einzelnen Funktionen vorhanden sind. Die Ausgabe erfolgt hier über einen
booleschen Wert, welcher entweder \texttt{true} oder \texttt{false} sein kann.
Anschließend kann der Entwickler diesen Code erneut anpassen und testen.
Nachfolgend sind zwei Tests für einen Akzeptanztest für das Modul Collectd
angehangen. Der vollständige Test ist dem Anhang beigefügt.
...
Wie auch für die~\ref{sec:unit_tests} werden Akzeptanztests für verschiedene
Betriebsysteme programmiert. Anders als bei~\ref{sec:unit_tests} werden diese
