...
geschützt sind, wie auch die Sicherheit der eigentliche Datenvisualisierung
gewährleistet werden kann. Im nachfolgendem werden beide Schnittstellen
erläutert.

Die erste Schnittstelle der Webseite ist ein standardisierter Treiber,
...
\textbf{Performance}
\begin{outline}
  \1 Da auf das Datenhaltungssystem nicht nur die Webseite zugreift,
  ...
  Webseite verursacht werden können. Ein wichtiges Kernkriterium ist, dass
  ...
  unterschiedliche Benutzer greifen gleichzeitig auf die Webseite zu und
...
für die Anzeige der Webseite zuständig. Der Carbon\hyp{}Cache\hyp{}Dienst
...
Webseite durchführen zu können, wird ein Benutzer und Kennwort benötigt.
Es ist hier nicht möglich, ein LDAP an die Webseite anbinden zu können.
...
Webseite. Mit dieser hat man die Möglichkeit, ein Dashboard, welches
...
Authentifizierung auf der Webseite durchzuführen. Ebenso werden alle
...
das gesamte Graphite-System und die Webseite wäre nicht mehr erreichbar.
...
nicht über normale Textdateien, sondern über eine API oder Webseite. Über
...
Nachdem der \texttt{grafana.service} gestartet wurde, kann die Webseite
...
von Grafana nicht definiert, jedoch kann dies die Performance der Webseite
...
übergeben. Das Puppet Profil prüft den Login auf die Webseite nicht,
da es davon ausgeht, dass die Anmeldemaske der Webseite unmittelbar
