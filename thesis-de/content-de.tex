...
Innerhalb des Moduls wird eine „grafana.pp“ Datei erstellt und anschließend
...
Das Puppet Modul prüft hier mit einem Login Versuch unmittelbar nach der
Installation, ob Grafana erreichbar ist. Dieses schlägt jedoch fehl, da es bis
zu einer Minute dauern kann, bis das Webinterface komplett erreichbar ist.
Wenn hier anschließend erneut der Befehl puppet apply ausgeführt wird, so wird
die Konfiguration erfolgreich implementiert. Abhilfe schafft hier, die
Anpassung der "grafana.pp" Datei. In dieser wird eine Verzögerung, bei der
Prüfung der erreichbarkeit festgelegt.
\mr%
