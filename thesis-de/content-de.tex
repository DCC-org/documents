...
einmal auf der Distribution ausgeführt werden muss, um Grafana zu
...
beigefügt. Zusätzlich kann hier auch die entsprechende Einheit für diese Werte
definiert werden, denn die erhaltenen Werte aus der Datenbank oder der
\gls{API} sind meist nur Ganz\hyp{} oder Kommazahlen Werte, welche keine
Einheiten übergeben bekommen.
\mr%

\subsubsection{Legend}
Unter dem Menüpunkt \texttt{Legend} wird die Legende für diesen Graphen
definiert. Eingestellt werden kann hier welchen Minimal\hyp{}, Maximal\hyp{},
Aktuell\hyp{} und Durschnittswert innerhalb der Analyse ausgegeben worden ist
und ob diese Werte als Tabelle ausgegeben werden sollen. Diese Ausgabe erfolgt
direkt unterhalb des Graphen und soll für eine bessere Übersichtlichkeit für
den Administrator dienen, da dieser die Minimal\hyp{} und Maximalenwerte, sowie
...
options}, \texttt{Series overrides} und \texttt{Thresholds}. Der Aufbau
...
Konfiguration, kann für jeden Graphen individuell die Kriterien definiert
...
Kommunikationsweg die Benachrichtigungen erfolgen soll.
\mr%
...
Testszenarien definiert werden können. Die Puppet Module welche in diesem
...
werden, ob das Profil auf unterschiedlichen Betriebssystemen ausgeführt werden
