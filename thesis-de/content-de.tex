...
angefertigt. Dabei kann jedes im Punkt~\ref{subsec:DBS_vorbereitung_der_evaluierung}
definierte Kriterium einen Wert zwischen 0 und 10 erhalten. Zehn ist dabei die
beste und Null die schlechteste Bewertung. Die Systeme mit der höchsten
Gesamtpunktzahl würden anschließend in der engeren Auswahl beurteilt werden.

Diese Entscheidungstabelle wurde wie folgt aufgebaut:
\begin{center}
\begin{tabular}{lcccc}
  \toprule
  System      & Vorhandenes Wissen & Skalierbarkeit & Umwelt & Datensicherung &
  Gesamtwert \\
  \midrule
  ...
  \bottomrule
\end{tabular}
\captionof{table}{Gesamtbewertung der Datenbank Systeme}
\end{center}
