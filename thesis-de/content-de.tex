...
Die Datenvisualisierung ist zueständig, für die Visualisierung der erhaltenen
verbrauchten oder freien Ressourcen, wie zum Beispiel CPU\hyp{}Auslastung oder
RAM\hyp{}Auslastung einzelner virtueller oder physischer Maschinen bereitstellen.
...
die für eine spätere Nutzwertanalyse verwendet wurden, kann dem Abschnitt
"Vorbereitung der Evaluierung für die
Datenvisualisierung"~\ref{subsec:vorbereiten_der_evaluierung_datenvisualisierung}
entnommen werden.
...
Innerhalb der Datenvisualisierungslösung werden dem User oder dem Administrator
...
Softwarelösung nicht weiter verwendet. Gridster\hyp{}D3 ist bereits
