...
mit dem HBase\hyp{}System über einfache Protokolle wie Telnet oder \gls{HTTP}
(\gls{API}).
...
dem bekannten Namen „\gls{SQL}“. Jedoch implementiert Apache Hive auf dem
...
Treiber an. Dieser kommuniziert mit einer Bibliothek des \gls{DBMS}\@. Der
...
des \gls{DBMS} an. Dafür muss der Treiber als auch die Bibiliothek auf dem
gleichen System vorhanden sein, wie die JVM\hyp{}Applikation. Die Datenbank
selbst kann auf dem gleichen Server oder über das Netzwerk angesprochen werden.
...
\begin{outline}
  ...
  der JDBC auf das spezifische \gls{DBMS} optimieren kann.
...
\gls{DBMS} solche Treiber zur Verfügung stellt. Für Postgres existieren solche
