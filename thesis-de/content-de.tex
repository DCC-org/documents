...
Bei der Evaluierung der API-Systeme wurden die im
...
der Webseiten-Anfrage und weitere Informationen wie der genutze Browser des
...
\begin{outline}
  ...
  muss diese mit einem \GLS{API}-System interagieren können, damit
...
Dies hat den Effekt, dass wenn der Server zum Beispiel für eine Minute eine
Auslastung von Null Prozent besitzt, für diese Minute nur ein einziger
Datensatz in der Datenhaltung existiert. Die in dem ETL Prozess fallen
gelassenen Werte kann man entsprechend bei der Ausgabe wieder berechnen.
Dadurch das jede Stunde mindestens ein Datensatz von jedem angebunden Server
in die Datenhaltung geschrieben wird, kann ebenfalls zwischen einem
ausgeschaltenden Server und einem Server ohne Nutzung unterschieden werden.
