...
wie zum Beispiel dem Versand einer eMail oder Anzeige auf einer Internetwebseite.

Apache Hive hat im Klartext die Aufgabe zur Bereitstellung einer strukturierten
Sicht auf die Daten innerhalb des Hadoop Systems. Dabei kann Apache Hive mehrere
Sichten (Schemas) auf einene einzelnen Datensatz definieren und somit auch das 
Rechtesystem innerhalb der Datenhaltung unterstützen. Die in dem Data Warehouse
bekannten ``Data Marts'' fallen somit weg und werden direkt auf dem Hadoop System
erzeugt und für ausgewählte Benutzeraccounts freigeschalten werden. 
\nl%
