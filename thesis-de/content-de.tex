...
Test Szenarien von \texttt{testkitchen} oder \texttt{serverspec} verwendet und
diese auf die im Projekt verwendeten Module angepasst. Der Code wird innerhalb
dieser Test tatsächlich ausgeführt und geprüft, ob die Funktionalität der
einzelnen Module für den Benutzer gegeben sind. Diese Szenarien prüfen
...
geprüft, ob das System stabil läuft sondern lediglich, ob die einzelnen
Funktionen vorhanden sind und funktionieren. Die Ausgabe erfolgt hier entweder
in Bestanden oder nicht Bestanden. Anschließend kann der Entwickler diesen Code
erneut anpassen und testen.
\mr%
