...
\begin{outline}
  ...
  benötigen keine große Schulung mit den Umgang der Datenvisualisierung. Dies
...
Community, in der viele inhaltliche Dokumente enthalten sind, sind hier nur für
Kunden bestimmt, welche eine Pro\hyp{}Lizenz besitzen. Ebenso gibt es
einen \gls{IRC-Channel}, um direkt Kontakt mit dem Support aufnehmen zu können
(vgl.~\cite{datadog}).
...
definiert. Es kann dort eingestellt werden welchen Minimal\hyp{},
...
Maximalenwerte, sowie Aktuelle\hyp{} und Durchnittswerte welche innerhalb der
