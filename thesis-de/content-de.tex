...
aussagekräftiger Titel, sowie Beschreibung des Graphen hinterlegt. In unserem
Beispiel, wird der Graph für die \texttt{CPU Usage} definiert. Unter dem Punkt
...
Übersichtlichkeit, wenn Administratoren oder die Führungsebene diese Graphen
...
Query} hinzugefügt werden. Hier wird zunächst eine Standard \texttt{SELECT}
...
definiert werden. Nun sollten bereits einzelne Werte im Graphen visualisiert
...
Im nachfolgenden Punkt \texttt{Axes} kann definiert werden, ob eine Y oder
X-Achse benötigt wird. Zusätzlich kann hier auch die entsprechende Einheit für
diese Werte definiert werden, denn die erhaltenen Werte aus der Datenbank sind
meist nur Double oder Integer Werte, welche keine Einheiten übergeben bekommen.
