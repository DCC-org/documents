...
Anwender erstellten Dashboards mit allen Graphen und
...
Statements, wie auch das gesamte Dashboard exportieren und importieren zu
...
Es ist hier nicht möglich, ein \GLS{LDAP} an die Weboberfläche anbinden zu
können. Innerhalb eines Graphen können bestimmte Teilabschnitte mit zum
Beispiel Social\hyp{}Media\hyp{}Plattformen wie Facebook oder Twitter geteilt
werden. Datadog bietet zudem eventbasierte Mitteilungen, welche vom
...
Dashboards können vom Administrator exportiert werden. Eine Möglichkeit,
Graphen zu exportieren, bietet Datadog hier nicht. Die Community, in der viele
inhaltliche Dokumente enthalten sind, sind hier nur für Kunden bestimmt, welche
eine Pro\hyp{}Lizenz besitzen. Ebenso gibt es hier einen \gls{IRC-Channel}, um
...
nicht über normale Textdateien, sondern über eine \gls{API} oder Weboberfläche.
Über die eigenen Typen kann Puppet auch hiermit interagieren und nicht nur die
...
vom Kunden gewünscht sind. Dashboards werden in der Konfigurationsdatei des
Puppet Moduls für Grafana als \gls{JSON} definiert und können im Nachhinein
angepasst werden.
