...
in einer Liste für eine darauffolgende Evaltution definieren. Bei der
Erstellung dieser Liste wurden Systeme aufgenommen, welche die 
Projektmitglieder aus vergangenen Projekten, bzw. aus dem täglichen
Arbeitstag kennen. Zusätzlich hatten die Projektmitglieder vorab mit
...
Evaltution erfolgt nur nach einer Genehmigung vom Auftraggeber.
...
Relevanz jedes Kirteriums von dem Teammitglieder beurteilt und 
festgelegt. 
...
\begin{outline}
  ...
  Die Verwendung von einem statischen System, in Hinsicht der oben
  genannten Ressourcen, ist ein K.O. Kriterium für die Evalution. 
  \1 Die Performance und Effizients der Datenbank
  \1 OpenTSDB
  \1 KNIME
  \1 impala
  \1 hadoop
