...
Updates. Entwickelt wird das Projekt von ~\cite{systat_releases}. Das
Featureset von sysstat ist sehr umfangreich. Neben den geforderten Kriterien
zur lokalen Datenerfassung liefert es auch viele weitere Details. Hierzu zählen
zum Beispiel Statistiken zum Verhalten des Arbeitsspeichers. Die Interrupt
Verarbeitung des Prozessors und detailierte Netzwerkinformationen. Ermittelte
Daten können als CSV, XML oder JSON gespeichert werden~\cite{sysstat_features}.
\tm%
