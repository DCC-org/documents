...
Besonderheiten oder Funktion aufweist. Dabei ist aufgefallen, dass das 
Zabbix-Frontend ohne einen Zabbix Server nicht verwendet werden kann. Der
Zabbix Server ist eins von Zabbix eigen Entwickelter Server, der für die 
Analyse der Systemressourcen, ähnlich wie collectd zuständig ist. Zusätzlich
viel auf, das Zabbix-Frontend maximal nur mit einer Datenbank gleichzeitig
kommunizieren und verwenden kann. Anders als bei Grafana, wo mehrere
Datenbanken eingebunden werden können, welche über die Abfragen der Graphen
angesprochen werden können, kann dies bei Zabbix nicht umgesetzt werden. Die
Datenhaltungssoftware postgres bietet zudem eine Cluster High Avaibility(HA)
möglichkeit, wodurch auch die Systemsicherheit in Ausfall und Verlust 
gewährleistet werden kann. Aus diesen Grunden, welche nicht bestandteil des
Anforderungskatalog sind, jedoch die anderen Lösungen nicht aufweisen, fällt
Zabbix-Frontend aus der Verwendung und Nutzung im Projekt heraus.
\mr%
