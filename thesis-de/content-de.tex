...
\subsection{Vorbereitung der Evaluierung}
\label{subsec:api_vorbereitung_der_evaluierung} Anders als bei der Evalierung
der Datenbanksysteme wurde bei der Evaluierung der möglichen API-Systeme keine
Liste im Voraus erstellt. Dies lag daran, dass keines der Projektmitglieder
oder keiner der Interessenten an dem Projekt Erfahrungen mit API-Systemen im
Vorhinein besaß und dies erst während der Projektphase angeeignet werden
musste.
