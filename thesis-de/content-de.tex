...
setzen. Hierbei wird die Differenz zwischen zwei Messpunken betrachtet.
Beispiel: Das Betriebssystem misst die geschriebene Datenmenge auf einen
Datenträger seit dem Startvorgang in Bytes. Interessant für den Anwender ist
aber der Datendurchsatz in \si{\mega\byte\per\second} oder
...
Datenmenge seit Systemstart geschrieben und gelesen wurde. Diese Messwerte sind
$m_i,\; i ∈ ℕ$. Danach kann die durchschnittliche Durchsatzrate $D_i$ zwischen
zwei Messpunkten $m_i$ und $m_{i-1}$ bestimmen durch
...
\begin{tabular}{lcr}
  ...
  Zugewiesener Arbeitsspeicher & Ja & Nein \\
  Anzahl Prozessorkerne & ✗ & ✔ \\
  Datenträger Durchsatz & ✗ & ✔ \\
  Netzwerk Durchsatz & ✗ & ✔ \\
\end{tabular}
\tm%
