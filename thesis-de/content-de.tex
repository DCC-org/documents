...
Abschnitt~\ref{section:Begriffserklärung} erklärt. Das gleiche gilt für
...
und bietet eine eiheitliche Schnittstelle an. Dies ermöglicht es Coreutils, vom
Host aus Daten der VMs zu ermitteln.
\tm%
...
Evalutionskriterien aus Punkt~\ref{subsec:DBS_vorbereitung_der_evaluierung}
...
Implementierung wie in Punkt~\ref{subsubsec:hadoop_beschreibung}. Apache Impala
...
\begin{outline}
  ...
  Anschluss während dem Kompiliervorgang in einem strukturierten Dokument
...
API~\ref{sec:schnittstelle_datenbereitstellung} fähig, dies bedeutet, dass
das Datenhaltungssystem API Statements zur Verfügung stellen können und hiermit
Graphen visualisieren kann. Grafana kann über einem \gls{Datenbanktreiber} oder
einer Schnitstelle in Form eines Treibers, einfache Statements auf das
