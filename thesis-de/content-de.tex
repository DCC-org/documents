...
von dem in Abschnitt~\ref{sec:api_system} definierten API-System verwendet.
Dieser besitzt keine direkten Lese- oder Schreibrechte auf die in der
definierten Bibiliothek vorhandenen Tabellen. Er erhält lediglich ausführende
