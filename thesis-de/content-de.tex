...
analysiert. Im zweiten Schritt werden nun die einzelnen Graphen definiert.
Hierzu muss unter \texttt{Metrics} zunächst ausgewählt werden, von welcher
Datenquelle die erhaltenen Daten stammen. Die Datenquelle muss zuvor, wie in
~\ref{sec:realisierung_grafana} beschrieben hinterlegt werden.  
\mr%
