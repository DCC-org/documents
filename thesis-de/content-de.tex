...
Für die im Projekt verwendete Datenerhaltung, welche über eine API
Schnittstelle realisiert wurde, ist die Erstellung eines eigenen Users pro
Kunde wichtig, da jeweils pro User eine OrgID für die Dashboards definiert
werden. Diese OrgID ist für die API, wie in
Abschnitt~\ref{subsec:zusammenspiel_api_frontend} die eindeutige Zuordnung zum
Kunden, damit hier ein Kunde nur seine eigenen Server und nicht die von anderen
Kunden einsehen kann.
