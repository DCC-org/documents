...
umgesetzt werden. Dies hat ebenfalls den Nachteil, dass falls eine High
Avaibility Lösungen seitens des Kunden gewünscht wird, diese mit Zabbix nicht
umgesetzt werden kann. Eine High Avibility Lösung sind zum Beispiel zwei
Datendenbanken, die Redundant an das WebFrontend angebunden werden können. Durch
ein HA System kann eine Systemsicherit in Ausfall und Verlust gewähleistet
werden. Da dies nicht Bestandteil unseres Anforderungskatalogs ist, jedoch die
anderen zwei Systeme diese Unterstützung bieten fällt Zabbix-Frontend aus der
weiteren verwendung und Nutzung im Projekt heraus.
\mr%
